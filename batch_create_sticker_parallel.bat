...
if "%~1"=="" (
    ...
    echo   - Or specify file paths: batch_create_sticker_parallel.bat "file1.png" "file2.png"
    echo.
    echo This will process images in PARALLEL using all CPU cores
    echo Output files will have _sticker suffix
    echo.
    pause
    exit /b 1
)
...
echo ========================================
echo Batch Sticker Creation - Parallel
echo ========================================
echo.
...
python batch_create_sticker.py --parallel !ARGS!
